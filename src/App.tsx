...
import LandBorrowingListingForm from "./components/LandBorrowingListingForm";
import "./index.css";
...
function App() {
  ...
  return (
    <>
      ...
      <main id="main-content">
        <section className="hero" aria-label="Introduction to WeedLend Finance">
          <div className="container">
            ...
            <p>
              Secure decentralized funding, land loans, seed purchases, land lending, and
          ...
          <div className="container">
            ...
            <div className="description-grid">
              <div className="description-item" onClick={() => openModal("growers")}>
                <h3>Growers</h3>
                <p>
                  Access funding for <span className="highlight">Cannabis</span> cultivation
                  by listing land as collateral.
                </p>
              </div>
              ...
              <div className="description-item" onClick={() => openModal("borrow")}>
                <h3>Borrow</h3>
                <p>
                  Borrow land for <span className="highlight">Cannabis</span> growing with
                  flexible terms.
                </p>
              </div>
          ...
          <div className="modal-content">
            ...
            <section id="lenders" className="section" aria-label="Lenders Section">
              <div className="container">
                <h2>Our Lenders</h2>
                <ErrorBoundary>
                  <LoanListingForm address={address} /> {/* Line 338 */}
                </ErrorBoundary>
                {address && <LoanListings address={address} />} {/* Line 340 */}
              </div>
            </section>
          </div>
        </div>
      ...
      {modals.borrow && (
        <div className="modal" role="dialog" aria-label="Borrow Modal">
          <div className="modal-content">
            <button
              className="modal-close"
              onClick={() => closeModal("borrow")}
              aria-label="Close modal"
            >
              ×
            </button>
            <section id="borrow" className="section" aria-label="Borrow Section">
              <div className="container">
                <h2>Borrow Land</h2>
                <ErrorBoundary>
                  <LandBorrowingListingForm />
                </ErrorBoundary>
                {address && <LandBorrowings address={address} />}
              </div>
            </section>
          </div>
        </div>
